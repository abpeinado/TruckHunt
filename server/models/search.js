...
module.exports.scheduleData = () => {
  return db.query('SELECT v.vendor_id, v.vendor_name, v.phone_number, s.day_of_week, s.start_time, s.end_time, s.coordinates, r.rating from vendors as v inner join schedules as s on v.vendor_id = s.vendor_id inner join reviews as r on v.vendor_id = r.vendor_id;');
};
